 ...
 */
public class TechnoArt extends JPanel {
   
   /**
    * main() routine opens a window that shows a TechnoArt panel
    * and its menu bar.  The program ends when the user closes the window.
    */
   public static void main(String[] args) {
      JFrame window = new JFrame("TechnoArt");
      TechnoArt content = new TechnoArt();
   ...
   public JMenuBar createMenuBar() {
      ...
      customColor.addActionListener( new ActionListener() { 
         ...
         public void actionPerformed(ActionEvent evt) {
            Color c = JColorChooser.showDialog(TechnoArt.this,
